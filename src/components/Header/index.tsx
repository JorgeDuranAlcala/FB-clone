...
function Header({ classes }: IHeaderProps): ReactElement {
    ...
    const centerIcons = (
        <>
            <div className={`${classes.icon} ${classes.icon__active}`}>
        ...
        <>
            <header className={classes.root}>
                <div className={classes.header__left}>
                    <img className={classes.facebook__Icon} alt="facebook-icon" src={facebookSvgIcon} />
